...
public class OrderBillManagerController {
    ...
    @GetMapping("/init")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "start_time", value = "开始时间 2020-06-01 00:00:01", required = true, dataType = "string",paramType = "query"),
            @ApiImplicitParam(name = "end_time", value = "结束时间 2020-06-30 23:59:59", required = true, dataType = "string",paramType = "query"),
    })
