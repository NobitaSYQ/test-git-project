...
Class.mixin = function(members) {
    ...
    /* A rectangular panel that is absolutely positioned over other context
------------------------------------------------------------------------------------------------------------------------
Options:
	- className (string)
	- context (HTML string or jQuery element set)
	- parentEl
	- top
	- left
...
var Popover = Class.extend({
	...
	// Creates `this.el` and renders context inside of it
	render: function() {
		var _this = this;
	...
	renderHelper: function(event, sourceSeg) {
		...
		this.rowEls.each(function(row, rowNode) {
			...
			if (sourceSeg && sourceSeg.row === row) {
				...
				skeletonTop = rowEl.find('.fc-context-skeleton tbody').position().top;
			}
...
DayGrid.mixin({
	...
	renderFgSegs: function(segs) {
		...
		// append to each row's context skeleton
		this.rowEls.each(function(i, rowNode) {
			$(rowNode).find('.fc-context-skeleton > table').append(
	...
	// Uses the given events array to generate <tbody> elements that should be appended to each row's context skeleton.
...
TimeGrid.mixin({
	...
	renderFgSegs: function(segs) {
		...
		this.el.append(
			this.eventSkeletonEl = $('<div class="fc-context-skeleton"/>')
...
var View = fc.View = Class.extend({
	...
	scrollerEl: null, // the element that will most likely scroll when context is too tall
	...
	initTheming: function() {
		...
		this.widgetContentClass = tm + '-widget-context';
...
var BasicView = fcViews.basic = View.extend({
	...
	// Generates the HTML that will go before context-skeleton cells that display the day/week numbers.
	...
	// Generates the HTML for the <td>s of the "number" row in the DayGrid's context skeleton.
...
fcViews.agenda = View.extend({ // AgendaView
	...
	// Affects context-skeleton, helper-skeleton, highlight-skeleton for both the time-grid and day-grid.
