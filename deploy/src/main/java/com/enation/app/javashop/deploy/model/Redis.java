...
public class Redis implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Redis that = (Redis) o;
        if (redisId != null ? !redisId.equals(that.redisId) : that.redisId != null) {
            return false;
        }
        if (redisType != null ? !redisType.equals(that.redisType) : that.redisType != null) {
            return false;
        }
        if (configType != null ? !configType.equals(that.configType) : that.configType != null) {
            return false;
        }
        if (standaloneHost != null ? !standaloneHost.equals(that.standaloneHost) : that.standaloneHost != null) {
            return false;
        }
        if (standalonePort != null ? !standalonePort.equals(that.standalonePort) : that.standalonePort != null) {
            return false;
        }
        if (standalonePassword != null ? !standalonePassword.equals(that.standalonePassword) : that.standalonePassword != null) {
            return false;
        }
        if (clusterNodes != null ? !clusterNodes.equals(that.clusterNodes) : that.clusterNodes != null) {
            return false;
        }
        if (sentinelMaster != null ? !sentinelMaster.equals(that.sentinelMaster) : that.sentinelMaster != null) {
            return false;
        }
        if (sentinelNodes != null ? !sentinelNodes.equals(that.sentinelNodes) : that.sentinelNodes != null) {
            return false;
        }
        if (deployId != null ? !deployId.equals(that.deployId) : that.deployId != null) {
            return false;
        }
        if (restAppid != null ? !restAppid.equals(that.restAppid) : that.restAppid != null) {
            return false;
        }
        if (restUrl != null ? !restUrl.equals(that.restUrl) : that.restUrl != null) {
            return false;
        }
        return true;
    }
