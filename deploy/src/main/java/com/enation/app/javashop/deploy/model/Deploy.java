...
public class Deploy implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (deployName != null ? !deployName.equals(that.deployName) : that.deployName != null) {
            return false;
        }
        if (remark != null ? !remark.equals(that.remark) : that.remark != null) {
            return false;
        }
        if (deployType != null ? !deployType.equals(that.deployType) : that.deployType != null) {
            return false;
        }
        if (adminName != null ? !adminName.equals(that.adminName) : that.adminName != null) {
            return false;
        }
        if (adminPwd != null ? !adminPwd.equals(that.adminPwd) : that.adminPwd != null) {
            return false;
        }
