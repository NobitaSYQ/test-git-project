...
public class GroupbuyGoodsManagerImpl extends AbstractPromotionRuleManagerImpl implements GroupbuyGoodsManager {
    ...
    public GroupbuyGoodsDO add(GroupbuyGoodsDO goodsDO) {
        ...
        //（秒杀活动开始时间小于等于当前活动开始时间 并且 秒杀活动结束时间大于等于当前活动开始时间）或者  第一种情况
        //（秒杀活动开始时间小于等于当前活动结束时间 并且 秒杀活动结束时间大于等于当前活动结束时间）或者  第二种情况
        //（秒杀活动开始时间小于等于当前活动开始时间 并且 秒杀活动结束时间大于等于当前活动结束时间）或者  第三种情况
        //（秒杀活动开始时间大于等于当前活动开始时间 并且 秒杀活动结束时间小于等于当前活动结束时间）     第四种情况
